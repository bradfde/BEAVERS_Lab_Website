...
```{r, out.width='150px', out.extra='style="float:above; padding:1px"', fig.alt = "Picture of a brown dog looking down with its tongue out against a grassy background.", echo=FALSE}
