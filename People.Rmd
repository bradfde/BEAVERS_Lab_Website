...
<!-- ```{r, out.width='150px', out.extra='style="float:above; padding:1px"', fig.alt = "DESCRIPTION", echo=FALSE} -->
<!-- knitr::include_graphics("images/FILE_NAME") -->
<!-- ``` -->
...
```{r, out.width='150px', out.extra='style="float:above; padding:1px"', fig.alt = "Picture of a smiling person.", echo=FALSE}
knitr::include_graphics("images/AubreyFPFP.png")
```

[Aubrey Freitas](AubreyF.html)
<br/>
**Graduate Student, Clinical Psychology**
<br/>
[CV](files/CVs/Freitas_CV.pdf) 
...
```{r, out.width='150px', out.extra='style="float:above; padding:1px"', fig.alt = "Picture of a smiling person.", echo=FALSE}
knitr::include_graphics("images/RachelG.png")
```

[Rachel Goldblum](RachelG.html) 
<br/>
**Graduate Student, Clinical Science**
<br/>
[CV](files/CVs/Goldblum_CV.pdf) 

<!-- [Google Scholar](https://scholar.google.com/citations?hl=en&user=6EXE-RUAAAAJ) [Twitter](https://twitter.com/fmwhittaker) -->
...
<br/>
[CV](files/CVs/Whittaker_CV.pdf) [Google Scholar](https://scholar.google.com/citations?hl=en&user=6EXE-RUAAAAJ) 
:::
<br/>
...
```{r, out.width='150px', out.extra='style="float:above; padding:1px"', fig.alt = "DESCRIPTION", echo=FALSE}
knitr::include_graphics("images/TaylorH.png")
```

[Taylor Hart](TaylorH.html)
<br/>
**Undergraduate Assistant Researcher**
:::
...
```{r, out.width='150px', out.extra='style="float:above; padding:1px"', fig.alt = "Selfie of a person with medium length curly hair, fair skin, and a black rain jacket against a background full of trees.", echo=FALSE}
knitr::include_graphics("images/ZarinaH.png")
```

[Zarina Hokawala](ZarinaH.html)
<br/>
**Undergraduate Assistant Researcher**
:::
...
```{r, out.width='150px', out.extra='style="float:above; padding:1px"', fig.alt = "DESCRIPTION", echo=FALSE}
knitr::include_graphics("images/CadenH.png")
```

[Caden Hooper](CadenH.html)
<br/>
**URSA Assistant Researcher**
:::
...
```{r, out.width='150px', out.extra='style="float:above; padding:1px"', fig.alt = "DESCRIPTION", echo=FALSE}
knitr::include_graphics("images/BochenL.png")
```

[Bochen Li](BochenL.html)
<br/>
**Volunteer Assistant Researcher**
:::
...
```{r, out.width='150px', out.extra='style="float:above; padding:1px"', fig.alt = "DESCRIPTION", echo=FALSE}
knitr::include_graphics("images/MessiM.png")
```

[Messi Morning](MessiM.html)
<br/>
**Volunteer Assistant Researcher**
:::
...
```{r, out.width='150px', out.extra='style="float:above; padding:1px"', fig.alt = "Picture of a smiling person with long strawberry blonde straight hair, fair skin, a black shirt and blue jeans against a pink background.",echo=FALSE}
knitr::include_graphics("images/KirstenR.png")
```
[Kirsten Ransford](KirstenR.html)
<br/>
**Undergraduate Assistant Researcher**
:::
...
knitr::include_graphics("images/MeganR.png")
```
[Megan Rutherford](MeganR.html)
<br/>
**Undergraduate Assistant Researcher**
:::
...
```{r, out.width='150px', out.extra='style="float:above; padding:1px"', fig.alt = "DESCRIPTION", echo=FALSE}
knitr::include_graphics("images/LinnaT.png")
```

[Linna Truong](LinnaT.html)
<br/>
**STEM Leaders Assistant Researcher**
:::
...
```{r, out.width='150px', out.extra='style="float:above; padding:1px"', fig.alt = "Selfie of a person with medium length curly hair, fair skin, and a black rain jacket against a background full of trees.", echo=FALSE}
knitr::include_graphics("images/MirandaV.png")
```

[Miranda Vogel](MirandaV.html)
<br/>
**Undergraduate Assistant Researcher**
:::
...
```{r, out.width='150px', out.extra='style="float:above; padding:1px"', fig.alt = "DESCRIPTION", echo=FALSE}
knitr::include_graphics("images/JJA.png")
```

[JJ Admire-Novak](JJA.html)
<br/>
**STEM Leaders Assistant Researcher 2024-2025**
:::
...
```{r, out.width='150px', out.extra='style="float:above; padding:1px"', fig.alt = "Selfie of a person with medium length curly hair, fair skin, and a black rain jacket against a background full of trees.", echo=FALSE}
knitr::include_graphics("images/BobbiB.png")
```

[Bobbi Bailey](BobbiB.html)
<br/>
**Undergraduate Assistant Researcher**
:::
...
<br/>
**Undergraduate Assistant Researcher, 2021-2024**
:::
...
```{r, out.width='150px', out.extra='style="float:above; padding:1px"', fig.alt = "Selfie of a person with medium length curly hair, fair skin, and a black rain jacket against a background full of trees.", echo=FALSE}
knitr::include_graphics("images/PuneetG.png")
```

[Puneet Gandhok](PuneetG.html)
<br/>
**Undergraduate Assistant Researcher 2024-2025**
:::
...
<br/>
**Honors Thesis Assistant Researcher, 2022-2024**
:::
...
```{r, out.width='150px', out.extra='style="float:above; padding:1px"', fig.alt = "Picture of a smiling person ", echo=FALSE}
knitr::include_graphics("images/EllieH.png")
```

[Ellie Hull](EllieH.html)
<br/>
**Undergraduate Assistant Researcher 2024-2025**<br/>
**Ellie is now an Instructional Aide at the Cottonwood Day School**
:::
...
```{r, out.width='150px', out.extra='style="float:above; padding:1px"', fig.alt = "DESCRIPTION", echo=FALSE}
knitr::include_graphics("images/KylerJ.png")
```

[Kyler Jones](KylerJ.html)
<br/>
**Volunteer Assistant Researcher 2024-2025**<br/>
**Kyler is now a PhD student in cognitive psychology at University of Connecticut **
:::
...
```{r, out.width='150px', out.extra='style="float:above; padding:1px"', fig.alt="Picture of a smiling person with dark hair.", echo=FALSE}
knitr::include_graphics("images/QiyingM.png")
```
[Qiying Ma](QiyingM.html)
<br/>
**STEM Leaders Assistant Researcher**
:::
...
```{r, out.width='150px', out.extra='style="float:above; padding:1px"', fig.alt = "DESCRIPTION", echo=FALSE}
knitr::include_graphics("images/JacksonM.jpeg")
```

[Jackson Marra-Dotts](JacksonM.html)
<br/>
**Volunteer Assistant Researcher 2023-2025**<br/>
**Jackson is now a lab manager at Virginia Commonwealth University Medical School**
:::
...
<br/>
**Volunteer Assistant Researcher, 2023-2024**
:::
...
```{r, out.width='150px', out.extra='style="float:above; padding:1px"', fig.alt="Picture of a smiling person with dark long hair in a car.", echo=FALSE}
knitr::include_graphics("images/MarissaP.jpg")
```
[Marissa Perez](MarissaP.html)
<br/>
**Volunteer Assistant Researcher 2023-2025**
:::
...
[EJ Rifkin](EJR.html)
<br/>
**Volunteer Assistant Researcher 2023-2024**<br/>
**EJ is now a MSc student in neuroscience at King’s College**
:::
...
<br/>
**Undergraduate Assistant Researcher, 2022-2024**
:::
...
<br/>
**Honors Thesis Assistant Researcher, 2021-2024**
:::
...
```{r, out.width='150px', out.extra='style="float:above; padding:1px"', fig.alt="Picture of a smiling person with dark hair and a black windbreaker in front of a brick building.", echo=FALSE}
knitr::include_graphics("images/CharlieX.png")
```
[Charlie Xu](CharlieX.html)
<br/>
**URSA Assistant Researcher, 2023-2025**
:::
