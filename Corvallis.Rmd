...
:::float-image
```{r out.width='75px', out.extra='style="float:above; padding:1px"', fig.cap= "One of our lab pets, Lucy, enjoying a hike in Bend, OR.", echo=FALSE}
knitr::include_graphics("images/Lucy_1.png")
```
:::

:::float-image
```{r out.width='75px', out.extra='style="float:above; padding:1px"', fig.cap= "One of our lab pets, Lucy, enjoying a sunset view in Corvallis.", echo=FALSE}
