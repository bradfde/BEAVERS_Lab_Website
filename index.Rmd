...
---
<img src="images/OSU1.png" alt="Oregon State University Campus on rainy day" style="width:800px;"/>

:::float-image

```{r out.width='150px', out.extra='style="float:left; padding:3px"', echo=FALSE}
